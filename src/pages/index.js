            ...
            return {
                ...
                draw: function() {
                    ...
                    if (this.type === 0) {
                        ...
                        const s = this.size * 0.8; ctx.beginPath(); ctx.moveTo(0, -s/2); ctx.lineTo(s/2, 0); ctx.lineTo(0, s/2); ctx.lineTo(-s/2, 0); ctx.closePath(); ctx.stroke();
                    }
                    ctx.restore();
                },
                update: function() {
                    ...
                    if (mouse.active && distToMouse < mouse.radius) {
                        ...
                        if(Math.random() > 0.98) { this.vx = (Math.random()-0.5); this.vy = (Math.random()-0.5); }
                    }
