  ...
  return (
    <svg className={styles.filmGrainOverlay}>
      <filter id="noiseFilter">
        <feTurbulence type="fractalNoise" baseFrequency="0.80" numOctaves="1" stitchTiles="stitch"/>
...
function TechInteractiveBackground() {
  ...
  useEffect(() => {
      ...
      return {
        ...
        update: function () {
          ...
          if (mouse.active && distToMouse < mouse.radius) {
            ...
            this.x += (mouse.x + Math.cos(this.currOrbitAngle) * this.orbitRadiusA - this.x) * 0.04;
            this.y += (mouse.y + Math.sin(this.currOrbitAngle) * this.orbitRadiusB - this.y) * 0.04;
          } else {
            this.x += (this.baseX - this.x) * 0.012 + this.vx;
            this.y += (this.baseY - this.y) * 0.012 + this.vy;
            if (Math.random() > 0.98) {
    ...
    const alphaVal = colorMode === 'dark' ? '0.20' : '0.25';
          ...
          <div className="container">
            <section className={styles.featureSection} ref={el => sectionRefs.current[0] = el}>
              ...
              <div className={styles.featureTextColumn}>
                ...
                <p className={styles.featureDescription}>
                  <Translate id="homepage.feature1.description">A professional, visual, and type-safe event architecture
                    for Unity. Streamline your development with our ScriptableObject-driven graph editor, designed for
                    performance and maintainability.</Translate>
                </p>
            ...
            <section className={`${styles.featureSection} ${styles.featureReverse}`}
              ...
              <div className={styles.featureTextColumn}>
                ...
                <p className={styles.featureDescription}>
                  <Translate id="homepage.feature2.description">We are building the next generation of core game
                    systems. Innovative tools that balance visual clarity with raw coding power, helping you build
                    giants from tiny ideas.</Translate>
                </p>
                <div className={styles.buttonGroup}>
                  <div className={styles.featureButtonDisabled}>
                    <span className={styles.btnIcon}>🔒</span> <Translate id="homepage.feature.inDevelopment">In
